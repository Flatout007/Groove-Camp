...
import SongModal from '../song/song_modal';
...
class GreetingIndex extends React.Component {
                 ...
                 <div className='flex-c'>
                    <div className="session--container">
                        <div className="logo-container">
                               <img className="logo" src="https://cdn3.iconfinder.com/data/icons/music-and-audio-1/26/music-audio-1027-512.png" alt="" />
             ...
             <div className='nav-hd-div'>
                 <div className='flex-c'>
                    <div className="session--container">
                        ...
                        <div className="session-nav">
                            <a className='signup' onClick={() => this.props.openModal('signup-modal')}>signup</a>
                            <a className='login' onClick={() => this.props.openModal('login')}>login</a>
                        </div>
                    </div>
                    </div>
             </div>
    ...
    render() {
        ...
        let albumModal = this.state.showAlbumForm ?
            <div onClick={() => this.setState({ showAlbumForm: false })} className='modal-background'>
                <AlbumModal />
            </div> : <div></div>;
...
export default withRouter(GreetingIndex);